...
def train_model(dataset, split, cuda, embeddings):
    ...
    for epoch in range(1, EPOCHS + 1):
        f = open(f'{root_path}{dataset}/train_{split}.txt', 'r')
        line = "123"
        k = 0
        while line:
            line = f.readline().rstrip('\n')
        ...
        ff = open(f'{root_path}{dataset}/val_{split}.txt', 'r')
        line = "123"
        k = 0
        while line:
        ...
        correct_labels_test = []
        predictions_test = []
        ff = open(f'{root_path}{dataset}/test_{split}.txt', 'r')
        line = "123"
        k = 0
        print("starttest:")
        while line:
...
if __name__ == '__main__':
    ...
    f = open("sentenceGCJwithid.txt", 'r')
    line = "123"
    listword = []
    while line:
        line = f.readline().rstrip("\n")
    ...
    train_model(args.dataset, args.split, args.cuda, dictfinalem)
