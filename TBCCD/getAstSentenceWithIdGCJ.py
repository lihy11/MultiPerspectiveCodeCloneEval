...
f = open("sentenceGCJwithid.txt", 'w')
listfile = os.listdir("../dataset/gcj/code/")
# print(listfile)
lisfinalfile = []
ff = open("flistGCJ.txt", 'w')
for lis in listfile:
    ff.write("../dataset/gcj/code/" + lis)
    ff.write('\t')
    lisfinalfile.append("../dataset/gcj/code/" + lis)
# print(lisfinalfile)
ff.close()
